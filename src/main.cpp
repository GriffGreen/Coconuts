...
uint256 hashGenesisBlock("0x5d14558a9193e7aac9217ef73bd3feb5b607d224c2b3654bd8b674a9d7633e66");
...
const string strMessageMagic = "coconuts Signed Message:\n";
...
//11 young coconuts are harvested for each climb (on a good tree)
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // coconuts: 1 days
static const int64 nTargetSpacing = 420; // coconuts: 8 minute harvests
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal coconuts miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "coconuts", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7a791d50b90092801ba0aa317e3da47d8175df4946ab5346e871332cd5c31316");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Coconut tree is no tree? Goa govt is nuts says Oppn - Jan 11th 2016 from The Tribune published in Chandigarh India";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1452576431; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 975799;

        if (fTestNet)
        {
            block.nTime    = 1452572845;
            block.nNonce   = 500738;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xba23bb3f6b22764e9dee04cd1c93c298fdf8d64f4524644c3cf60d5c805b5053"));
